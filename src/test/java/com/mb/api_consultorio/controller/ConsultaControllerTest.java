...
import com.mb.api_consultorio.domain.consulta.DatosDetalleConsulta;
...
class ConsultaControllerTest {
    ...
    @MockitoBean
    private ReservaDeConsulta reservaDeConsultas;
    ...
    void reservar_escenario2() throws Exception {
        ...
        verify(reservaDeConsultas).reservar(any(DatosReservaConsulta.class));
    }
}